...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative pt-40 min-h-screen flex items-center overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          `}>
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed max-w-lg mb-8">
              Train with cutting-edge equipment, learn from elite trainers, and become part of a champion-driven community. Your fitness journey begins
            </p>
          ...
          `}>
            ...
            <div className="relative rounded-lg hover:grayscale-100 cursor-pointer duration-700 ease-in-out overflow-hidden border border-white/5 aspect-[4/5]">
              <img
            ...
            <div className="absolute -left-6 top-12 bg-[#111] border border-white/10 rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-red-600 text-xs">100+ Members</div>
                </div>
              </div>
            </div>
