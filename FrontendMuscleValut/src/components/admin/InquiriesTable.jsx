      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        {inquiries.filter(i => i.status === 'new').length > 0 && (
          ...
          ">
            ...
            <span className="text-red-500 text-xs tracking-wider">
              {inquiries.filter(i => i.status === 'new').length} unread inquiries
            </span>
          </div>
        )}
      ...
      <div className="flex flex-col gap-3">
        ...
        {loading ? (
          ...
          [...Array(4)].map((_, i) => (
            ...
            <div
              key={i}
              className="bg-[#111] border border-white/5 rounded-xl p-5 animate-pulse"
            >
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              ...
              <div className="text-xs tracking-widest uppercase text-gray-600 mb-1">
                Subject
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {['new', 'read', 'replied', 'closed'].map((s) => (
                  ...
                  <button
                    ...
                    onClick={() => handleStatusUpdate(selected._id, s)}
                    className={`
                      py-2.5 rounded-lg text-xs uppercase
                      border transition-all duration-200 capitalize
                      ${selected.status === s
                        ? 'bg-red-600 border-red-600 text-white'
                        : 'border-white/10 text-gray-500 hover:border-red-600/50 hover:text-red-600'
