      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-sm mt-4 max-w-xl mx-auto leading-relaxed">
            Experience world-class facilities built to help you achieve your fitness goals and unlock your full potential.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-500 text-sm mb-4">
            Follow us on Instagram to see more photos and updates.
          </p>
          <a
